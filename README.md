...
To use it for compressing an input file, the following will be called: <h3>java -jar huffman_<id>.jar c absolute_path_to_input_file n</h3> 
    c means compressing the file. n is the number of bytes that will be considered together.
  
To use it for decompressing an input file, the following be called: <h3>java -jar huffman_<id>.jar d absolute_path_to_input_file</h3>
