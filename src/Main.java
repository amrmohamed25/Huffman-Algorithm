...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (cha.equals("c")) {
            ...
            String outputFile = "6304." + n + "." + p.getFileName().toString()+ ".hc";
...
//            String outputFile = "6304." + n + "." + inputFile + ".hc";
...
//        finding the time difference and converting it into seconds
            float sec = (end - start) / 1000F;
            System.out.println(sec + " seconds");
//            long fileInSize = new File(outputFile).length();//getting fileSize
//            long fileOutSize = new File(decompressedFile).length();//getting fileSize
//            System.out.println((float) fileOutSize / fileInSize);
        }
    }
}
